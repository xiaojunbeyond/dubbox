...
import com.alibaba.dubbo.common.utils.io.SerializerUtils;
 ...
 * @since 18 Jun 2013
 */
public class ObjectOutputWrapper implements ObjectOutput {
	...
	public ObjectOutputWrapper(AbstractObjectOutput objectOutput, OutputStream outputStream, int compressionThreshold, Compressor<byte[], byte[]> compressor) {
